...
public class BoardView extends GridLayout {
  ...
  private Float[][][] xs = new Float[9][2][4];
  ...
  public BoardView(Context context, AttributeSet attrs) {
    ...
    gridPaint.setColor(ContextCompat.getColor(context, R.color.dark_gray));
    oPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    oPaint.setColor(ContextCompat.getColor(context, R.color.game_green));
    oPaint.setStyle(Paint.Style.STROKE);
    xPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    xPaint.setColor(ContextCompat.getColor(context, R.color.game_red));
  ...
  private final ValueAnimator.AnimatorUpdateListener oUpdateListener =
      animation -> {
        float theta = (float) animation.getAnimatedValue();
